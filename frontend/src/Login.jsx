...
const Login = () => {
  return (
    <div className='lg:flex justify-between'>
      <div className='mx-6 sm:mx-6 lg:mx-auto' style={{marginTop: '14vh'}}>
        ...
        <div className='flex flex-col space-y-1 mt-5'>
          ...
          <input type="text" id='email' name='email' placeholder='Enter your email address' className='border rounded-lg h-10 p-6' />
        </div>
        <div className='flex flex-col space-y-1 mt-5'>
        ...
        <button className='bg-lime-500 text-white px-auto py-2 rounded-lg mt-4 w-full'>Log In</button>
      ...
      {/* <div className='bg-[url(LoginBack.jpg)]'></div> */}
      <img className='lg:-z-10 lg:h-1' src="LoginBack.jpg" alt="" style={{ height: '100vh' }} />
    </div>
  )
}
