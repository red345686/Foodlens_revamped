    ...
    <div className='flex justify-between'>
      <div className='m-24'>
        ...
        <div className='flex flex-col space-y-1 mt-4'>
          <label htmlFor="email" className='font-medium pl-3'>Email</label>
          <input type="text" id='email' name='email' placeholder='Enter your email addresss' className='border rounded-lg h-10 px-4' />
        </div>
        <div className='flex flex-col space-y-1 mt-4'>
          <label htmlFor="password" className='font-medium pl-3'>Password</label>
          <input type="text" id='password' name='password' placeholder='Enter your password' className='border rounded-lg h-10 px-4' />
        </div>
        ...
        <p>Don't have an account? <Link className='text-purple-600 underline font-semibold'>Register here</Link></p>
      </div>
