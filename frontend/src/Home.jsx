...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className='fixed w-auto bg-transparent lg:p-10 ml-[10vw] mr-[10vw] sm:mr-[30vw] md:mr-[50vw] h-screen flex flex-col justify-center text-center'>
        ...
        <div className='flex flex-col sm:flex-row sm:justify-evenly mt-10'>
          {!user && (
            <div className='sm:w-auto text-center text-lg sm:text-xl md:text-2xl my-2 lg:text-3xl text-white px-3 md:px-5 lg:px-8 py-2 md:py-3 lg:py-4 bg-red-600 rounded-2xl lg:rounded-3xl'>
